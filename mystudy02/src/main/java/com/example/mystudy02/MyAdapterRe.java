...
public class MyAdapterRe extends RecyclerView.Adapter<MyAdapterRe.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //拿到布局
       // View view = View.inflate(context, R.layout.recyclerview_item1, null, false);
        View view = LayoutInflater.from(context).inflate(R.layout.recyclerview_item1, parent, false);
